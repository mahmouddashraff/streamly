...
export default function AddChannelVideoPage({ params }: { params: Promise<{ id: string }> }) {
  const router = useRouter();
  const supabase = createClient();
  const { id: channel_id } = use(params);
        ...
        const upload = new tus.Upload(selectedFile, {
          ...
          onSuccess: async function () {
            ...
            if (dbError) {
               ...
               window.location.href = `/admin/channels/${channel_id}/content`;
            }
          },
        });
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold tracking-tight mb-8">Add Video to Channel</h1>
