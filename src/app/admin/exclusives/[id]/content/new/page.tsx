...
export default function AddExclusiveVideoPage({ params }: { params: Promise<{ id: string }> }) {
  const router = useRouter();
  const supabase = createClient();
  const { id: exclusive_id } = use(params);
        ...
        const upload = new tus.Upload(selectedFile, {
          ...
          onSuccess: async function () {
            ...
            if (dbError) {
               ...
               window.location.href = `/admin/exclusives/${exclusive_id}/content`;
            }
          },
        });
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold tracking-tight mb-8">Add Episode to Exclusive</h1>
