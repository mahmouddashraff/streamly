...
export default function AddTodaysEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: dbError } = await supabase.from('todays_events').insert(newTodaysEvent);
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold tracking-tight mb-8">Create New Today's Event Show</h1>
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-6 border-t border-border flex justify-end gap-4">
            ...
            >
              {isUploading ? "Saving..." : "Create Today's Event"}
            </button>
          </div>
        </form>
      </div>
